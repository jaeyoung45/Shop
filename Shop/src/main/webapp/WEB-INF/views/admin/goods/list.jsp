...
#container_box table omg { width: 150px;height: auto; }
</style>
			...
			<table>
				 ...
				 <tbody>
				  ...
				  <tr>
				   <td>
				   <c:choose>
				   	<c:when test="${list.gdsImg != null}"><!-- 이미지 있을때 출력 -->
				  <img alt="${list.gdsNum}번 상품 썸네일" src="/resources/imgUpload${list.gdsImg}">
				   	</c:when>
				   	<c:otherwise><!-- 이미지 없을때 출력 -->
				  <img alt="${list.gdsNum}번 상품 썸네일" src="/resources/imgUpload/none.png">
				   	</c:otherwise>
				   </c:choose>
				   </td>
				   <td>
