		...
		<div id="container_box">
			...
			<ul class="orderView">
				...
				<li>
					<div class="thumb">
						<c:choose>
							<c:when test="${orderView.gdsImg != null}">
								<!-- 이미지 있을때 출력 -->
								<img alt="${orderView.gdsNum}번 상품 썸네일" src="/resources/imgUpload${orderView.gdsImg}">
							</c:when>
							<c:otherwise>
								<!-- 이미지 없을때 출력 -->
								<img alt="${orderView.gdsNum}번 상품 썸네일" src="/resources/imgUpload/none.png">
							</c:otherwise>
						</c:choose>
					</div>
					<div class="gdsInfo">
						<p>
							...
							<span>개당 가격</span><fmt:formatNumber pattern="###,###,###" value="${orderView.gdsPrice}"/> 원
