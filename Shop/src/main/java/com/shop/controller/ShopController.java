...
public class ShopController {
	...
	public void getView(@RequestParam("n") int gdsNum, Model model) throws Exception {
		...
		if (view.getGdsImg() != null && !view.getGdsImg().equals("")) {
			String gdsImg = view.getGdsImg();
			String f = gdsImg.substring(0, gdsImg.indexOf("s_"));
			String l = gdsImg.substring(gdsImg.indexOf("s_") + 2);
			gdsImg = f + l;
	
			String gdsThumbImg = view.getGdsImg();
	...
	// 상품 소감(댓글) 삭제
	@ResponseBody
	@RequestMapping(value = "/view/deleteReply", method = RequestMethod.POST/*, produces = MediaType.APPLICATION_JSON_UTF8_VALUE*/)
